...
public class CourseDBManager implements CourseDBManagerInterface {
	...
	/**
	 * Method that takes given File object and creates CourseDBElement objects from
	 * the values from each line.
	 */
	@Override
	...
	/**
	 * Method that traverses through a hashtable and its buckets and converts each
	 * CourseDBElement object into a string that is put into a arraylist.
	 * 
	 * @return list
	 */
	@Override
